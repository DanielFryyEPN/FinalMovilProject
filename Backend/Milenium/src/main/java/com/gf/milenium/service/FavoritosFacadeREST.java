...
import com.gf.milenium.Favoritos;
import com.gf.milenium.FavoritosPK;
 ...
 */
@Stateless
@Path("com.gf.milenium.favoritos")
public class FavoritosFacadeREST extends AbstractFacade<Favoritos> {
    ...
    private FavoritosPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.gf.milenium.FavoritosPK key = new com.gf.milenium.FavoritosPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.gf.milenium.FavoritosPK key = getPrimaryKey(id);
