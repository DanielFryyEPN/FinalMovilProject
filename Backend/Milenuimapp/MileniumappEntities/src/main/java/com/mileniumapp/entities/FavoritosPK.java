 ...
 */
package com.mileniumapp.entities;
...
public class FavoritosPK implements Serializable {
    ...
    public String toString() {
        return "com.mileniumapp.entities.FavoritosPK[ idFavoritos=" + idFavoritos + ", usuarioidUsuario=" + usuarioidUsuario + ", cooerdenadasidCooerdenadas=" + cooerdenadasidCooerdenadas + " ]";
    }
